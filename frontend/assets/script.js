(function () {
      ...
      fetch(`${basePath}actions/add_to_cart.php`, {
        ...
        .then((data) => {
          ...
          if (data.success) {
            ...
            if (
              typeof data.itemQuantity === "number" &&
              data.itemQuantity > 0
            ) {
            ...
            const metaMessage =
              data.metaMessage ||
              "Log in or create an account from the menu to continue.";
            showNotification({
              message:
                data.message ||
  ...
  function setupAddToCartButtons() {
    document
      .querySelectorAll(".add-to-cart[data-product-id]")
      .forEach(bindAddToCartButton);
  }
